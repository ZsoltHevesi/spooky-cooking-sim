...
@export var unlimited : bool ## If [code]true[/code], makes the spawner unlimited, ignoring [param spawned]. By default spawner works only once (cont. in [param spawned]).
@export var spawned : bool ## If [code]true[/code], the spawner will not instantiate again until [param spawned] is turned [code]false[/code].
